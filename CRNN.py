...
def word_model():
    ...
    reversed_gru_1b = Lambda(lambda inputTensor: tf.reverse(inputTensor, axis=[1]), output_shape=(32,256))(gru_1b)
    ...
    gru_2b = GRU(256, return_sequences=True, go_backwards=True, kernel_initializer='he_normal', name='gru2_b')(
        gru1_merged)
    reversed_gru_2b = Lambda(lambda inputTensor: tf.reverse(inputTensor, axis=[1]), output_shape=(32,256))(gru_2b)
